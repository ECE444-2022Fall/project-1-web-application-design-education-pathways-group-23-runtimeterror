...
def test_sv_frontend():
    ...
    assert (
        student_info.find_element(By.XPATH, "//table/tr[1]/td[2]").text
        == "Your Major is: EngSci"
    )
    assert (
        student_info.find_element(By.XPATH, "//table/tr[1]/td[3]").text
        == "Earned Credits: 0"
    )
    assert (
        student_info.find_element(By.XPATH, "//table/tr[2]/td[1]").text
        == "Major Completion: Incomplete"
    )
    assert (
        student_info.find_element(By.XPATH, "//table/tr[2]/td[2]").text
        == "Planned Credits: 0"
    )
    ...
    assert (
        drag_container.find_element(
            By.XPATH, "//ul[@class='drag-list']/li[3]/span/h2"
        ).text
        == "FALL 2020"
    )
    ...
    course = drag_container.find_element(
        By.XPATH, "//ul[@class='drag-list']/li[3]/ul/li[1]"
    ).text
    color = drag_container.find_element(
        By.XPATH, "//ul[@class='drag-list']/li[3]/ul/li[1]"
    ...
    course = drag_container.find_element(
        By.XPATH, "//ul[@class='drag-list']/li[3]/ul/li[2]"
    ).text
    color = drag_container.find_element(
        By.XPATH, "//ul[@class='drag-list']/li[3]/ul/li[2]"
    ).value_of_css_property("color")
    ...
    course = drag_container.find_element(
        By.XPATH, "//ul[@class='drag-list']/li[4]/ul/li[1]"
    ).text
    ...
    drag_container.find_element(
        By.XPATH, "//ul[@class='drag-list']/li[4]/form/button[2]"
    ).click()
    ...
    drag_container.find_element(
        By.XPATH, "//ul[@class='drag-list']/li[3]/form/button[2]"
    ).click()
    ...
    drag_container = driver.find_element(By.CLASS_NAME, "drag-container")
    course = drag_container.find_element(
        By.XPATH, "//ul[@class='drag-list']/li[3]/ul/li"
    ).text
    color = drag_container.find_element(
        By.XPATH, "//ul[@class='drag-list']/li[3]/ul/li"
    ).value_of_css_property("color")
    ...
    course = drag_container.find_element(
        By.XPATH, "//ul[@class='drag-list']/li[4]/ul/li"
    ).text
    assert course == "ECO101H1"
