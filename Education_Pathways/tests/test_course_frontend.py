...
def test_course_frontend():
    ...
    assert (
        driver.find_element(By.CLASS_NAME, "course-title").text
        == "ECE444H1 : Software Engineering"
    )
    assert (
        driver.find_element(By.CLASS_NAME, "course-description").text
        == "Course Description\n"
    ...
    prerequisites = driver.find_element(
        By.XPATH, "//div[@class='col-item course-requisite row']/div[3]/div[1]"
    )
