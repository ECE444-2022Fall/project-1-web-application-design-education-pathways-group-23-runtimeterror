...
def test_minor_completion(minor):
    ...
    assert minor.check_completion(correct_course_list), "This course list should fulfill minor requirements"

    # Check blank list
    incorrect_course_list1 = []
    assert not minor.check_completion(incorrect_course_list1), "This course list should not fulfill minor requirements"
    ...
    assert not minor.check_completion(incorrect_course_list2), "This course list should not fulfill minor requirements"
...
def test_major_completion(major):
    ...
    # Check blank list
    incorrect_course_list1 = []
    assert not major.check_completion(incorrect_course_list1), "This course list should not fulfill minor requirements"

    # Check incorrect list with course that fulfills multiple requirements
    incorrect_course_list2 = ["ESC499Y1", "MIE429H1", "MIE451H1", "ECE352H1", "CSC310H1"]   
    assert not major.check_completion(incorrect_course_list2), "This course list should not fulfill minor requirements"