...
def ENGB29H3_course():
    ...
    return Course(mongodb_document_data)


def test_course_construction(ENGB29H3_course):
...
def test_course_get_course_weight(ENGB29H3_course):
