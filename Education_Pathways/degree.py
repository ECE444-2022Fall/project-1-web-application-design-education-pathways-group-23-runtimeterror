...
class Major(Degree):
    ...
    class Requirements:
        ...
        def __contains__(self, course) -> bool:
            ...
            return any(
                ...
                for requirement in self.core_requirements + self.elective_requirements
            )
    ...
    def check_progress(self, course_list) -> list:
        ...
        for requirement in (
            ...
            + self.requirements.elective_requirements
        ):
            if set(requirement).isdisjoint(course_list):
...
class Minor(Degree):
    ...
    def serialize(self):
        ...
        """
        return {"name": self.name, "requirements": self.requirements}
